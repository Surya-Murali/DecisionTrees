...
dataT = pd.read_csv('C:/Users/surya/Desktop/SpringSemester/IDA/HW1/Biomechanical_Data_column_2C_weka_Transformed.csv')

print("DataT Shape: \n", dataT.shape)
print("DataT Head: \n", dataT.head())

shuffledataT = shuffle(dataT)

print("Data2Shuffle Shape: \n", shuffledataT.head())

#Gives first 210 records
train_dataT = shuffledataT[:210]
#Gives last 100 records
test_dataT = shuffledataT[-100:]
...
trainFeatures = list(train_dataT.columns[:6])
print("Features: \n", trainFeatures)

X = train_dataT[trainFeatures]
print("X: \n", X.head())
...
tFeatures = list(test_dataT.columns[:6])
print("Features: \n", tFeatures)

testFeatures = test_dataT[tFeatures]
print("Test Features: \n", testFeatures.head())

testPrediction = classifier.predict(testFeatures)
print("Test Prediction: \n", testPrediction)

testActual = list(test_dataT["class"])
print("Test Actual: \n", testActual)
