...
data2 = pd.read_csv('C:/Users/surya/Desktop/SpringSemester/IDA/HW1/BiomechanicalData_column_3C_weka.csv')
...
ax.xaxis.set_ticklabels(['Hernia', 'Normal', 'Spondylolisthesis']); ax.yaxis.set_ticklabels(['Spondylolisthesis', 'Normal', 'Hernia']);
